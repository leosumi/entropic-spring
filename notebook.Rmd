...
The simulation contains a single polymer constituated of 14 beads. The simulation runs during 5000 time steps. A force is applied on both ends of the polymer from time step 2000.
...
As espected, a greater force will strech the spring more.
...
A force of 50 or 10 was applied from time 2000 to 5000. Before the force is applied, we can see that the spring containsing sticky beads has a smaller end to end length. After the force is applied, the effect of the sticky bead is negligable compared to the effect of the force in the case of a large force used. If a smaller force is applied to the spring, like a force of 10, the sticky beads have a greater effect.

The applied force will overstrech the spring. For this reason, the average end to end length will be calculated from time 2500. 
...
A force too large will disrupt the spring. We can also that the sticky bead effect is mostly visible when the force is small.
...
The spring constant is not constant, but it seams to be similar between the spring containing sticky beads and the one containing none. The plot shows that the spring constant increase with respect to the average end-to-end length
